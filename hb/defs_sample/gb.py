"sample HB run with GB: function (and parameter space) definitions for hyperband"
"regression with gradient boosting"

from common_defs import *

# a dict with x_train, y_train, x_test, y_test
from load_data_for_sample import data
...
space = {
	...
	'criterion': hp.choice( 'c', ( 'friedman_mse', 'squared_error')),	# sklearn 0.18
